...
-- Table: Reply
CREATE TABLE Reply (r_ID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
 reply TEXT NOT NULL, 
 user_fk_ID INT (11) REFERENCES Users (User_ID) NOT NULL, 
 c_fk_ID INT (11) REFERENCES Conversation (c_ID) NOT NULL,
